...
author: Ignasi Bartomeus^1^, Francisco Rodriguez^1^
...
> reproducibilidad; rstats; gbif; datos abiertos 


# Keywords

> reprudibility; rstats; gbif; open data
...
Un ejemplo de este tipo de paquetes es bajar datos de tu especie favorita de gbif usando el paquete `rGbif`. Vamos a verlo en tres simples pasos que apenas ocupan cuatro lineas de codigo en R.
...
```{r}
dat <- occ_search(scientificName = "Andrena flavipes", limit = 1000)
dat
```
