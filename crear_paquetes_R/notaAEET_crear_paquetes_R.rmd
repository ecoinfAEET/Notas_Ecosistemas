...
# En este chunk los reseteamos a EVAL=FALSE para que no se evalúen durante 
# la compilación del documento, pero haciendo esto podríamos ejecutar:
#
# knitr::purl("Cómo crear paquetes de  R.rmd")
# 
# lo que nos generaría el archivo "Cómo crear paquetes de  R.R" con todo el 
# código necesario. Haciendo:
# 
# source("Cómo crear paquetes de  R.R")
#
...
encoding: UTF-8
````
Si queremos hacer todo esto directamente desde R, sólo tendremos que escribir:  
```{r}
dir.create("paqueteR")
setwd("./paqueteR")
